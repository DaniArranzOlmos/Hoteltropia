  ...
  xhr.onreadystatechange = function()
  {
    if (this.readyState == 4 && this.status == 200)
    {
      ...
      for (let hotel of hoteles1)
      {
        ...
        if (searchData.value.toLowerCase().trim()==hotel.nombre.toLowerCase().trim() || searchData.value.toLowerCase().trim()==hotel.ciudad.toLowerCase().trim() || searchData.value.toLowerCase().trim()==hotel.categoria || searchData.value.toLowerCase().trim()==hotel.pvp)
        {
